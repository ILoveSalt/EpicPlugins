...
package hgds.epicgrief.epiccoins.core.config;
...
public class Config extends SimpleConfig{
    ...
    public Config(EpicCoinsPlatform platform) {
    ...
    public void registerDefaults() {
        addValue("storage.folder", new File(this.platform.getFolder(), "data").getPath());
        ...
        addValue("storage.database", "EpicCoins");
        ...
        colors.add("epiccoins.color.admin:&4");
        colors.add("epiccoins.color.developer:&b");
        colors.add("epiccoins.color.mod:&c");
        colors.add("epiccoins.color.supporter:&9");
        colors.add("epiccoins.color.builder:&3");
        colors.add("epiccoins.color.youtuber:&5");
        colors.add("epiccoins.color.premium:&6");
        ...
        add("permissions.admin", "epiccoins.admin");
        add("permissions.coins.see", "epiccoins.coins.see");
        add("permissions.coins.seeothers", "epiccoins.coins.see.others");
        add("permissions.coins.top", "epiccoins.coins.top");
        add("permissions.coins.pay", "epiccoins.coins.pay");

        add("hook.vault.enabled", true);
        add("hook.vault.priority", "Highest");

        add("messages.prefix", "&8» &6EpicCoins &8| &f");
        ...
        add("messages.command.help.header", "&8--------[&6EpicCoins&8]--------");
