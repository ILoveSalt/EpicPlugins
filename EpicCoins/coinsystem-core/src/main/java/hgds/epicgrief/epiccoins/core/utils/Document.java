package hgds.epicgrief.epiccoins.core.utils;
...
public class Document {
    ...
    public static Document loadDataSave(String jsonString) throws Exception{
        return new Document(JsonParser.parseString(jsonString).getAsJsonObject());
    }
    ...
    public static Document loadDataSave(File file) throws Exception{
        ...
        JsonObject datas = JsonParser.parseReader(bufferedreader).getAsJsonObject();
