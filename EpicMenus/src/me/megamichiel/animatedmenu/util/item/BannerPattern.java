...
public class BannerPattern implements MaterialSpecific.Action<BannerMeta> {
    ...
    static {
        ...
        try {
            setBaseColor = BannerMeta.class.getMethod("setBaseColor", DyeColor.class);
        ...
        PATTERN_TYPES['B' - 'A'] = PatternType.SMALL_STRIPES;
        ...
        PATTERN_TYPES['l' - 'A'] = PatternType.DIAGONAL_UP_LEFT;
        PATTERN_TYPES['x' - 'A'] = PatternType.DIAGONAL_UP_RIGHT;
        PATTERN_TYPES['t' - 'A'] = PatternType.CIRCLE;
        PATTERN_TYPES['v' - 'A'] = PatternType.RHOMBUS;
        PATTERN_TYPES['H' - 'A'] = PatternType.HALF_VERTICAL;
        PATTERN_TYPES['q' - 'A'] = PatternType.HALF_HORIZONTAL;
        PATTERN_TYPES['M' - 'A'] = PatternType.HALF_VERTICAL_RIGHT;
        PATTERN_TYPES['L' - 'A'] = PatternType.HALF_HORIZONTAL_BOTTOM;
    ...
    public void apply(Player player, BannerMeta meta, PlaceholderContext context) {
        if (baseColor != null) {
            if (IS_LEGACY && SET_BASE_COLOR != null) {
                try {
                    SET_BASE_COLOR.invoke(meta, baseColor.getColor());
